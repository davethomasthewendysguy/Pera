...
$hupso_all_services = array(
	'Facebook', 'Twitter', 'Google Plus', 'Pinterest', 'Linkedin', 'Tumblr', 'StumbleUpon', 'Digg', 'Reddit', 'Bebo', 'Delicious', 'VKontakte', 'Odnoklassniki', 'Sina Weibo', 'QZone', 'Renren', 'Email', 'Print'
);
$hupso_default_services = array(
	'Facebook', 'Twitter', 'Google Plus', 'Pinterest', 'Linkedin', 'StumbleUpon', 'Digg', 'Reddit', 'Bebo', 'Delicious'
);	

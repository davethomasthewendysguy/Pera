...
function super_plugin_keithics_menu() {
	...
	add_menu_page('Restaurant Menu Editor', 'Restaurant Menu Editor'.$pending, 'manage_options', 'super_plugin_keithics', 'super_plugin_keithics_options');    
...
function super_plugin_keithics_options() {
	...
	echo '<div class="wrap">';
    echo '<h2>Restaurant Menu Editor v.02</h2>';
    include('table.php');
	echo '</div>';
}
...
function adrotate_license_mail_support() {
	if(wp_verify_nonce($_POST['adrotate_nonce_support'],'adrotate_nonce_support_request')) {
		...
		if(strlen($text) < 1) {
			...
			$message = "<p>From: $author<br />Website: $wpurl<br />WordPress Version: $wpversion<br />WordPress Multisite: $multisite<br />WordPress Language: $wplang<br />WordPress Charset: $wpcharset<br />Plugin Version: $version<br />License Type: $license<br />License Key: $key<br />Plugin is networked: $networked</p>";	
			$message .= "<p>$text</p>";

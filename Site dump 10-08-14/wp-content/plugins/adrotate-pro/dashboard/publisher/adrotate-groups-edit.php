...
<form name="editgroup" id="post" method="post" action="admin.php?page=adrotate-groups">
	...
	<p><em><?php _e('These are required.', 'adrotate'); ?></em></p>
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td colspan="2">
		        <p><em><?php _e('\'Dynamic mode\' requires \'jQuery\' and \'jQuery Showoff\' to be loaded. You can enable this in AdRotate Settings.', 'adrotate'); ?></em></p>
			</td>
		</tr>
		</tbody>
	</table>
	...
	<h3><?php _e('Advanced', 'adrotate'); ?></h3>
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td>
				<label for="adrotate_admargin_top">Top: <input tabindex="9" name="adrotate_admargin_top" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin; ?>" autocomplete="off" /> Bottom: <input tabindex="10" name="adrotate_admargin_bottom" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_bottom; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.<br />Left: <input tabindex="11" name="adrotate_admargin_left" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_left; ?>" autocomplete="off" /> Right: <input tabindex="12" name="adrotate_admargin_right" type="text" class="search-input" size="3" value="<?php echo $edit_group->admargin_right; ?>" autocomplete="off" /> <?php _e('pixel(s)', 'adrotate'); ?>.</label>
			</td>
			<td colspan="2">
		        <p><em><?php _e('A transparent area outside the advert in pixels. Default: 1.', 'adrotate'); ?></em></p>
			</td>
		</tr>
		<?php if($adrotate_config['enable_geo'] > 0) { ?>
	    <tr>
			<th width="15%"><?php _e('Geo Targeting', 'adrotate'); ?></th>
			<td width="35%"><label for="adrotate_geo"><input tabindex="13" type="checkbox" name="adrotate_geo" value="1" <?php if($edit_group->geo == '1') { ?>checked="checked"<?php } ?> /> <?php _e('Enable GeoTargeting for this group.', 'adrotate'); ?></label></td>
	    ...
	    <tr>
			...
			<td>
				...
				<select tabindex="14" name="adrotate_fallback">
      	...
      	<tr>
	        ...
	        <td><label for="adrotate_sortorder"><input tabindex="15" name="adrotate_sortorder" type="text" size="5" class="search-input" autocomplete="off" value="<?php echo $edit_group->sortorder;?>" /></label></td>
   	...
   	<table class="widefat" style="margin-top: .5em">
      	<tr>
	        ...
	        <label for="adrotate_cat_location">
		        <select tabindex="16" name="adrotate_cat_location">
      	...
      	<tr>
	        ...
	        <label for="adrotate_page_location">
		        <select tabindex="18" name="adrotate_page_location">
	...
	<p class="submit">
   	...
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="21" name="adrotate_wrapper_before" cols="65" rows="3"><?php echo stripslashes($edit_group->wrapper_before); ?></textarea></td>
			<td width="35%">
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="22" name="adrotate_wrapper_after" cols="65" rows="3"><?php echo stripslashes($edit_group->wrapper_after); ?></textarea></td>
			<td>
	...
	<p class="submit">
		<input tabindex="23" type="submit" name="adrotate_group_submit" class="button-primary" value="<?php _e('Save Group', 'adrotate'); ?>" />
		<a href="admin.php?page=adrotate-groups&view=manage" class="button"><?php _e('Cancel', 'adrotate'); ?></a>
	</p>

...
<?php } ?>
	...
	<table class="widefat" style="margin-top: .5em">
		<tbody>
      	...
      	<tr>
	        ...
	        <td colspan="3"><?php echo plugins_url(); ?>/<?php echo ADROTATE_FOLDER; ?>/library/clicktracker.php?track=<?php echo adrotate_clicktrack_hash($edit_banner->id, 0, 1, $blog_id); ?></td>
      	</tr>
      	</tbody>
	</table>
		...
		<?php if($adrotate_config['enable_stats'] == 'Y') { ?>
      	<tr>
	        ...
	        <td colspan="3">
		        ...
		        <?php if($adrotate_config['clicktracking'] == 'Y') { ?>
				        ...
				        <?php } else { ?>
				        <em><?php _e('Place the target URL in the field below, use %link% in the adcode instead of the target URL and enable clicktracking - Similar to code example 2.', 'adrotate'); ?></em>
		        <?php } ?>
		        </label>
	        </td>
      	</tr>
      	<tr>
	        ...
	        <td colspan="3">
		        ...
		        <em><?php _e('Enter the target URL for your advert here if you do not use jQuery for clicktracking or if you use a remote link.', 'adrotate'); ?></label>
	        </td>
      	</tr>
		<?php } ?>
      	<tr>
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<tbody>
      	...
      	<tr>
	        <th width="15%"><?php _e('Email or Remote page:', 'adrotate'); ?></th>
	        <td colspan="3"><?php echo plugins_url(); ?>/adrotate-pro/library/clicktracker.php?track=<?php echo adrotate_clicktrack_hash($edit_banner->id, 0, 1, $blog_id); ?></td>
      	</tr>
      	</tbody>

...
<form method="post" action="admin.php?page=adrotate-schedules">
	...
	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td colspan="3"><label for="adrotate_spread"><input tabindex="33" type="checkbox" name="adrotate_spread" value="1" <?php if($edit_schedule->spread == 'Y') { ?>checked="checked"<?php } ?> /> <?php _e('Try to evenly spread impressions for each advert over the duraction of this schedule. This may cause adverts to intermittently not show.', 'adrotate'); ?></label></td>
		</tr>
		<?php } ?>
		</tbody>	

...
/*--- AdRotate values ---------------------------------------*/
define("ADROTATE_DISPLAY", '3.10.2 Professional');
...
//	$adrotate_license_domain = 'http://dev4.ajdg.net';
	  	...
	  	<form name="settings" id="post" method="post" action="admin.php?page=adrotate-settings">
			...
			<table class="form-table">
				...
				<tr>
					...
					<td>
						<label for="adrotate_notification_push_user"><input name="adrotate_notification_push_user" type="text" class="search-input" size="50" value="<?php  echo $adrotate_notifications['notification_push_user']; ?>" autocomplete="off" /> Get your user token <a href="https://pushover.net" target="_blank">here</a>.</label>
					</td>
				</tr>
				<tr>
					<th valign="top"><?php _e('Api Token', 'adrotate'); ?></th>
					<td>
						<label for="adrotate_notification_push_api"><input name="adrotate_notification_push_api" type="text" class="search-input" size="50" value="<?php  echo $adrotate_notifications['notification_push_api']; ?>" autocomplete="off" /> Create your <a href="https://pushover.net/apps/build" target="_blank">App</a> and get your API token <a href="https://pushover.net/apps" target="_blank">here</a>.</label>
					</td>
				</tr>
<!--
				<tr>

...
function woo_custom_styling() {
	...
	if ( isset( $woo_options['woo_style_disable'] ) && $woo_options['woo_style_disable'] != 'true' ) {} else {
		...
		if ( $h3_css != '' )
			$output .= '.widget .widget-title {'. $h3_css . '}'. "\n";
...
<div id="navigation">
	...
	if ( function_exists( 'has_nav_menu' ) && has_nav_menu( 'primary-menu' ) ) {
		wp_nav_menu( array( 'walker' => new Woo_Navigation(), 'sort_column' => 'menu_order', 'container' => 'ul', 'menu_id' => 'main-nav', 'menu_class' => 'nav fl', 'theme_location' => 'primary-menu' ) );
	} else {
	?>
...
?>
	<div id="top">
		<div class="col-full">
			<?php wp_nav_menu( array( 'walker' => new Woo_Navigation(), 'depth' => 6, 'sort_column' => 'menu_order', 'container' => 'ul', 'menu_id' => 'top-nav', 'menu_class' => 'nav fl', 'theme_location' => 'top-menu' ) ); ?>
		</div>
	</div><!-- /#top -->
<?php
	}
...
add_action( 'woo_shortcode_view_full_article', 'woo_shortcode_view_full_article_override', 10, 2);
if ( ! function_exists( 'woo_shortcode_view_full_article_override' ) ) {
function woo_shortcode_view_full_article_override ( $output, $atts ) {
	$defaults = array(
	...
	$atts['label'] = __( 'Read More', 'woothemes' );
...
add_filter( 'woo_foot', 'woo_page_css' );
add_filter( 'woo_foot', 'woo_page_js' );

 ...
 */
 ...
 $title_before = apply_filters( 'title_before', '<' . $heading_tag . ' class="title">');
 $title_after = apply_filters( 'title_after', '</' . $heading_tag . '>');
...
/*	woo_the_title( array( 'before' =>  $title_before, 'after' => $title_after ) );*/
?>
	<div class="entry">
	    <?php
	    	if ( ! is_singular() ) {

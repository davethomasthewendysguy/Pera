...
// Show layout option on all pages
	...
	function woo_custom_headings() {
		$output = '';
		$output .= '<li class="wf-tab-backgrounds"><a href="#wf-tab-backgrounds" style="padding-left: 30px;">' . __( 'Background', 'woothemes' ) . '</a></li>' . "\n";
		...
		//$output .= '<li class="wf-tab-header"><a href="#wf-tab-hooks" style="padding-left: 30px;">' . __( 'Hooks', 'woothemes' ) . '</a></li>' . "\n";
	...
	function woo_tabbed_metaboxes($output){
		...
		if (get_post_meta($post->ID, '_page_background_image',true) != '')
			$info_msg = '<img height="500" src="' . get_post_meta($post->ID, 'image',true) . '"><br>You can cange your background under the Assets tab.<br>URL: ' . get_post_meta($post->ID, '_page_background_image',true);
		else
			$info_msg = 'You have not uploaded a background image. You can change your background under the Assets tab.';

		$woo_metaboxes_tab1[] =  array (
			"name" => "_page_background_repeat_info",
		...
		$woo_metaboxes_tab1[] =  array (
			"name" => "_page_background_repeat",
			"label" => "Backround Repeat",
			"type" => "radio",
			"std" => 'stretch',
			"options" => array(
				'stretch' => " Stretch <i>(Use <b>Background Responsive Centering</b> to customize settings.)</i>",
				'no-repeat' => ' Do not repeat',
				'repeat-x' => " Repeat Horitontally",
				'repeat-y' => " Repeat Vertically",
				'repeat' => " Repeat"),
			"desc" => "Specify how your background will repeat."
		);



		$woo_metaboxes_tab1[] =  array (
			"name" => "_page_background_center",
			"label" => "Backround Resposive Centering",
			"type" => "radio",
			"std" => 'center-x',
			"options" => array(
				'center-x' => " Only Center Horizontally",
				'center-y' => " Only Center Vertically",
				'center-both' => " Center in both positions"),
			"desc" => "Position for responsive background images only."
		);
			...
			$woo_metaboxes_tab3[] =  array (
				"name" => "_page_additioanal_classes",
				"label" => "Additional Page Classes",
				"type" => "text",
				"desc" => "Add extra classes to the page."
			);

			$woo_metaboxes_tab3[] =  array (
				"name" => "_page_title_before",
				"label" => "Add content before title.",
				"type" => "textarea",
				"desc" => "Add content before title. <b>Warning: This will not be displayed if you select the option to Hide Page Title. </b>"
			);

			$woo_metaboxes_tab3[] =  array (
				"name" => "_page_title_after",
				"label" => "Add content after title.",
				"type" => "textarea",
				"desc" => "Add content after title.  <b>Warning: This will not be displayed if you select the option to Hide Page Title. </b>"
			);
		...
		$output .= woothemes_metabox_create_fields($woo_metaboxes_tab1, $settings, 'backgrounds');

...
,
								'woo_header_inside_top' => array(
										'content' => '', 
										'shortcodes' => 0, 
										'php' => '', 
										'description' => __( 'Executed at the top, just above the end of the <code>#header</code> DIV tag but above where woo_header_inside will place code.', 'woothemes' )
									),
								...
								'woo_header_inside_bottom' => array(
										'content' => '', 
										'shortcodes' => 0, 
										'php' => '', 
										'description' => __( 'Executed at the top, inside the <code>#header</code> DIV tag but above where woo_header_inside will place code.', 'woothemes' )
									),

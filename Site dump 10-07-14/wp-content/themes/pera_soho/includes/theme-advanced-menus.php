...
/**
 * Many thank you's to http://wordpress.stackexchange.com/users/8138/djrmom for this code. 
 * Works like a charm! :D Forked it baby!
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <p class="field-custom description description-wide">
                <label for="edit-menu-item-custom-<?php echo $item_id; ?>">
                    <?php _e( 'Analytics Code (onclick handler)' ); ?><br />
